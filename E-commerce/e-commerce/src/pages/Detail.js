...
const Detail = () => {
  ...
  return (
    <div className='w-full items-center flex justify-center space-x-5'>
      ...
      <div className='w-2/3 space-y-5'>
        ...
        <button onClick={addCard} className='bg-indigo-800 p-3 w-full text-center rounded-lg text-white text-lg'>Sepete Ekle</button>
      </div>
    </div>
  )
}
