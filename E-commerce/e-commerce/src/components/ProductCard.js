...
const ProductCard = ({prd}) => {
  ...
  return (
    <div className='hover:border-indigo-800 w-1/5 h-[350px] border rounded-lg m-2 flex flex-col items-center p-1 space-y-2'>
      ...
      <button className='bg-indigo-800 w-full p-2 rounded-lg text-white'>SEPETE EKLE</button>
    </div>
  )
}
